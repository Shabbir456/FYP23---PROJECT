...
const UserProfileView = () => {
    ...
    useEffect(() => {
        ...
        onValue(starCountRef, (snapshot) => {
            const data = snapshot.val();
            setEmail(data.Email)
            setInsta(data.InstagramCredential)
            setFB(data.FacebookCredential)
            setYT(data.YoutubeCredential)
