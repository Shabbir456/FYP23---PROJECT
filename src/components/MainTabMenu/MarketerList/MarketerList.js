...
const MarketerList = () => {
    ...
    return (
        ...
        <View style={styles.container}>
            ...
            <View style={{ flex: 1, backgroundColor: '#f3c6ff', borderColor: '#f3c6ff', borderTopWidth: 2, borderStartWidth: 2, borderEndWidth: 2, borderRadius: 50, borderBottomLeftRadius: 0, borderBottomRightRadius: 0 }}>
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        <View style={{ marginLeft: 20, flexDirection: 'row' }} >
                            ...
                            <View style={{ width: '70%', alignItems: 'flex-start', borderBottomEndRadius: 20, borderTopEndRadius: 20, justifyContent: 'center', marginLeft: 2, marginTop: 20, backgroundColor: '#d7a1f9', }}>
                                ...
                                <Text style={{ color: '#fff', fontSize: 14, marginTop: -5 }}>  {item.userEmail}</Text>
                                <View style={{ flexDirection: 'row', paddingTop: 10, paddingBottom: 10, paddingLeft: 10 }}>
                                    ...
                                    <TouchableOpacity style={{ marginLeft: 5, paddingLeft: 10, backgroundColor: '#9d00c8', width: 80, height: 25, borderRadius: 10, paddingTop: 2, borderColor: '#fff', borderWidth: 0.5 }} onPress={() => navigation.navigate("MarketerView", {guestUid: item.guestUid})} >
