...
const SocialTips = () => {
    ...
    return (
        <ScrollView showsVerticalScrollIndicator={false} style={styles.container}>
            ...
            <Swiper autoplay height={200} horizontal={false} activeDotColor="#9D00C8">
               <View style={styles.slide}>
                <Image source={require('../SocialTips/banner3.png')}
                resizeMode="stretch"
        ...
        <View style={styles.cardsWrapper} >
            ...
            <Image 
            source={require('../SocialTips/images/1400845.png')}
                resizeMode="cover"
        ...
        <View style={styles.cardsWrapper}>
            ...
            <View style={styles.cardImageWrapper}>
            <Image 
            source={require('../SocialTips/images/images.jpg')}
                resizeMode="cover"
                style={styles.cardImg} />
            </View>
            <View style={styles.cardInfo}>
        ...
        <View style={styles.cardsWrapper}>
            ...
            <View style={styles.cardImageWrapper}>
            <Image 
            source={require('../SocialTips/images/icon.png')}
                resizeMode="cover"
                style={styles.cardImg} />
            </View>
            <View style={styles.cardInfo}>
